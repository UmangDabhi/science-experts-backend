...
let PaymentController = class PaymentController {
    constructor(enrollmentRepository, paymentService) {
...
__decorate([
    ...
    (0, common_1.Post)(api_message_1.API_ENDPOINT.CREATE_PAYMENT),
    (0, constants_1.ResponseMessage)(resposne_message_1.MESSAGES.PAYMENT_CREATED),
...
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    (0, common_1.Post)(api_message_1.API_ENDPOINT.VERIFY_PAYMENT),
    (0, constants_1.ResponseMessage)(resposne_message_1.MESSAGES.PAYMENT_VERIFIED),
